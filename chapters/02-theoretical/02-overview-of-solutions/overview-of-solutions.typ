...
==== Raspberry Pi
Seria Raspberry Pi jest najbardziej  wspieraną platformą dla Home Assistant. Jej popularność wynika z przystępnej ceny i ogromnego wsparcia społeczności. System "Home Assistant OS" (HAOS) jest specjalnie zoptymalizowany dla Raspberry Pi.

#figure(
  image("images/raspberrypi.png", width: 70%),
  caption: [Raspberry Pi pozostaje standardem dla entuzjastów automatyki domowej.],
)
